    ...
    <div class="window">
        <form action="" class="add-music-form" @submit="upload" v-if="!success">
            ...
            <div class="add-music-form__row">
                ...
                <input type="text" name="performer" id="performer" class="add-music-form__input"
                       :class="{'add-music-form__input--error': $v.performer.$error}"
                       v-model.trim.lazy="$v.performer.$model">
            ...
            <div class="add-music-form__row">
                ...
                <input type="text" name="album" id="album" class="add-music-form__input" v-model.lazy="$v.album.$model"
                       :class="{'add-music-form__input--error': $v.album.$error}">
            ...
            <div class="add-music-form__row">
                ...
                <input type="file" name="preview" id="preview" @change="changePreview"
                       class="add-music-form__input-preview" ref="inputPreview">
                <span class="add-music-form__error"
                      v-if="!$v.preview.validateImg">Только картинки jpg, jpeg и png</span>
            </div>
            <div class="add-music-form__row">
                <button @click="addTracks" type="button" class="add-music-form__add-tracks">
                    <PlusSVG></PlusSVG>
                    Добавить треки
                </button>
                <input type="file" name="audio" id="audio" multiple @change="changeAudio"
                       class="add-music-form__input-tracks" ref="inputTrack">
